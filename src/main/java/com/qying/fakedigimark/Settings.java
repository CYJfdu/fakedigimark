...
public class Settings {
    public static int pdpWidth = 16;
    public static double strength = 25.0;
    public static double baseColor = 0.96;
    public static int[] x = new int[]{3, 3, 2, 2, 1, 1, 0, 0, 1, 1, 0, 0, 3, 3, 2, 2};
    public static int[] y= new int[]{4, 5, 4, 5, 6, 7, 6, 7, 4, 5, 4, 5, 6, 7, 6, 7};
